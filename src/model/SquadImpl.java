...
public class SquadImpl implements Squad {
	...
	@Override
	public void purchaseSupply(String supply_name, int count, Store store) throws ItemNotForSaleException, InsufficientFundsException, IllegalArgumentException {
